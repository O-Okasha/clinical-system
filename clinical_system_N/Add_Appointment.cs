...
namespace clinical_system_N
{
    public partial class AddAppointment : Form
    {
        ...
        private bool Validation()
        {
            ...
            if (textBox1.Text == "" || maskedTextBox1.Text.Length > 50 || maskedTextBox1.Text.Contains(" ") || !isValid_name(maskedTextBox1.Text))
            {
            ...
            if (maskedTextBox2.Text == "" || maskedTextBox2.Text.Length > 50 || maskedTextBox2.Text.Contains(" ") || !isValid_name(maskedTextBox2.Text))
            {
