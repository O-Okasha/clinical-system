        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (validation)
            {
                try
                {
                    ...
                    list.Clear();
                    string emp = "";
                    string q = string.Format("select EMPLOYEE_NUMBER from EMPLOYEE where EMAIL = {0}", email.Text);
                    ...
                    list.Add(licsenceNumber.Text);
                    list.Add(emp);
                    list.Add(specialization.Text);
                    list.Add(address.Text);
                    db.CUD(CrudType.insert, "DOCTOR", list);
